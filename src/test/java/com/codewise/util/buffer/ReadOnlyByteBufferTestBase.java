...
abstract class ReadOnlyByteBufferTestBase<B extends ReadOnlyByteBufferImpl<?>> extends ByteBufferTestBase<B> {
    ...
    protected MutableMemory memoryMockWithCapacityOf50;
    ...
    public Object[][] getMethodsWithoutIndex() {
        return new Object[][]{
                {methodForReference((BufferGetMethod) ReadOnlyByteBuffer::get), methodForReference((MemoryGetMethod) MutableMemory::get), Byte.BYTES, (byte) 1},
                {methodForReference((BufferGetMethod) ReadOnlyByteBuffer::getChar), methodForReference((MemoryGetMethod) MutableMemory::getChar), Character.BYTES, 'a'},
                {methodForReference((BufferGetMethod) ReadOnlyByteBuffer::getShort), methodForReference((MemoryGetMethod) MutableMemory::getShort), Short.BYTES, (short) 2},
                {methodForReference((BufferGetMethod) ReadOnlyByteBuffer::getInt), methodForReference((MemoryGetMethod) MutableMemory::getInt), Integer.BYTES, 3},
                {methodForReference((BufferGetMethod) ReadOnlyByteBuffer::getLong), methodForReference((MemoryGetMethod) MutableMemory::getLong), Long.BYTES, 4l},
                {methodForReference((BufferGetMethod) ReadOnlyByteBuffer::getDouble), methodForReference((MemoryGetMethod) MutableMemory::getDouble), Double.BYTES, 123.32d}
        };
    }
    ...
    public Object[][] getMethodsWithIndex() {
        return new Object[][]{
                {methodForReference((BufferGetIndexedMethod) ReadOnlyByteBuffer::get), methodForReference((MemoryGetMethod) MutableMemory::get), Byte.BYTES, (byte) 1},
                {methodForReference((BufferGetIndexedMethod) ReadOnlyByteBuffer::getChar), methodForReference((MemoryGetMethod) MutableMemory::getChar), Character.BYTES, 'a'},
                {methodForReference((BufferGetIndexedMethod) ReadOnlyByteBuffer::getShort), methodForReference((MemoryGetMethod) MutableMemory::getShort), Short.BYTES, (short) 2},
                {methodForReference((BufferGetIndexedMethod) ReadOnlyByteBuffer::getInt), methodForReference((MemoryGetMethod) MutableMemory::getInt), Integer.BYTES, 3},
                {methodForReference((BufferGetIndexedMethod) ReadOnlyByteBuffer::getLong), methodForReference((MemoryGetMethod) MutableMemory::getLong), Long.BYTES, 4l},
                {methodForReference((BufferGetIndexedMethod) ReadOnlyByteBuffer::getDouble), methodForReference((MemoryGetMethod) MutableMemory::getDouble), Double.BYTES, 123.32d}
        };
    }

    @Test(dataProvider = GET_METHODS_WITHOUT_INDEX)
    public void getShouldInvokeGetRangeCheckWithCurrentPositionAndTypeSize(MethodCall<ReadOnlyByteBuffer> getMethod, MethodCall<MutableMemory> memoryGetMethod, int returnTypeSize, Object returnValueExample) {
        // given
    ...
    @Test(dataProvider = GET_METHODS_WITHOUT_INDEX)
    public void getShouldDelegateToMemoryGet(MethodCall<ReadOnlyByteBuffer> getMethod, MethodCall<MutableMemory> memoryGetMethod, int returnTypeSize, Object returnValueExample) {
        // given
        whenCall(memoryGetMethod).invokedOn(memoryMockWithCapacityOf10).withParams(anyInt()).thenReturn(returnValueExample);
    ...
    @Test(dataProvider = GET_METHODS_WITHOUT_INDEX)
    public void getShouldChangePosition(MethodCall<ReadOnlyByteBuffer> getMethod, MethodCall<MutableMemory> memoryGetMethod, int returnTypeSize, Object returnValueExample) {
        // given
        whenCall(memoryGetMethod).invokedOn(memoryMockWithCapacityOf10).withParams(anyInt()).thenReturn(returnValueExample);
        ReadOnlyByteBuffer buffer = bufferForMemory(memoryMockWithCapacityOf10).position(1);
...
*/
    ...
    public void getWithIndexShouldInvokeGetRangeCheckWithIndexAndTypeSize(MethodCall<ReadOnlyByteBuffer> getMethod, MethodCall<MutableMemory> memoryGetMethod, int returnTypeSize, Object returnValueExample) {
        // given
        whenCall(memoryGetMethod).invokedOn(memoryMockWithCapacityOf10).withParams(anyInt()).thenReturn(returnValueExample);
    ...
    @Test(dataProvider = GET_METHODS_WITH_INDEX)
    public void getWithIndexShouldDelegateToMemoryGet(MethodCall<ReadOnlyByteBuffer> getMethod, MethodCall<MutableMemory> memoryGetMethod, int returnTypeSize, Object returnValueExample) {
        // given
        whenCall(memoryGetMethod).invokedOn(memoryMockWithCapacityOf10).withParams(anyInt()).thenReturn(returnValueExample);
    ...
    @Test(dataProvider = GET_METHODS_WITH_INDEX)
    public void getWithIndexShouldDelegateToMemoryComputingMemoryPositionUsingBaseOffset(MethodCall<ReadOnlyByteBuffer> getMethod, MethodCall<MutableMemory> memoryGetMethod, int returnTypeSize, Object returnValueExample) {
        // given
        whenCall(memoryGetMethod).invokedOn(memoryMockWithCapacityOf50).withParams(anyInt()).thenReturn(returnValueExample);
    ...
    @Test(dataProvider = GET_METHODS_WITH_INDEX)
    public void getWithIndexShouldNotChangePosition(MethodCall<ReadOnlyByteBuffer> getMethod, MethodCall<MutableMemory> memoryGetMethod, int returnTypeSize, Object returnValueExample) {
        // given
        whenCall(memoryGetMethod).invokedOn(memoryMockWithCapacityOf10).withParams(anyInt()).thenReturn(returnValueExample);
        ReadOnlyByteBuffer buffer = bufferForMemory(memoryMockWithCapacityOf10).position(4);
