...
import static pl.codewise.util.buffer.ByteBufferAssertions.assertThat;

public abstract class ByteBufferTestBase<B extends AbstractByteBuffer<?>> {

    protected ByteBufferMemory memoryMockWithCapacityOf10;

    @BeforeMethod
    public void setUpMemoryMockWithCapacityOf10() {
        memoryMockWithCapacityOf10 = mock(ByteBufferMemory.class);
    ...
    public void limitQueryShouldDelegateToUnderlyingMemoryIfLimitWasResetToMemoryCapacity() {
        // given
        ByteBufferMemory memory = mock(ByteBufferMemory.class);
...
*/
    ...
    public void compareToShouldDelegateToMemoryCompareOfCommonRemainingBytes() {
        ...
        given(memoryMockWithCapacityOf10.compare(anyInt(), any(ByteBufferMemory.class), anyInt(), anyInt())).willReturn(Integer.MIN_VALUE);
        ...
        ArgumentCaptor<ByteBufferMemory> memoryArgumentCaptor = ArgumentCaptor.forClass(ByteBufferMemory.class);
    ...
    public void compareToShouldReturnRemainingDifferenceIfMemoryEqual() {
        ...
        given(memoryMockWithCapacityOf10.compare(anyInt(), any(ByteBufferMemory.class), anyInt(), anyInt())).willReturn(0);
    ...
    public void equalsShouldReturnFalseIfValuesOfRemainingDiffers() {
        ...
        // then
        verify(memoryMockWithCapacityOf10, never()).compare(anyInt(), any(ByteBufferMemory.class), anyInt(), anyInt());
    ...
    public void equalsShouldDelegateToMemoryCompareAndReturnTrueIfComparationResultIsZero() {
        ...
        // then
        verify(memoryMockWithCapacityOf10).compare(anyInt(), any(ByteBufferMemory.class), anyInt(), anyInt());
    ...
    public void equalsShouldDelegateToMemoryCompareAndReturnFalseIfComparationResultIsNonZero() {
        ...
        given(memoryMockWithCapacityOf10.compare(anyInt(), any(ByteBufferMemory.class), anyInt(), anyInt())).willReturn(1);
    ...
    protected abstract B bufferForMemory(ByteBufferMemory memory);

    protected abstract B bufferForMemoryAndBaseOffset(ByteBufferMemory memory, int baseOffset);
}