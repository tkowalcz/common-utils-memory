...
class ReadOnlyByteBufferImpl<B extends ReadOnlyByteBuffer<B>> extends AbstractByteBuffer<B> implements ReadOnlyByteBuffer<B> {
    ...
    ReadOnlyByteBufferImpl(ByteBufferMemory memory) {
        super(memory);
    }

    @Override
    public ReadOnlyByteBuffer<?> wrap(ReadOnlyMemory memory) {
        ByteBufferMemory memoryToWrap = memory instanceof ByteBufferMemory ? (ByteBufferMemory) memory : new ReadOnlyMemoryAdapter(memory);
...
class ReadOnlyMemoryAdapter implements ByteBufferMemory {
