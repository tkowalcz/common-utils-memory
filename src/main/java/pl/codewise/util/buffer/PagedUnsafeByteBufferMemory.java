...
class PagedUnsafeByteBufferMemory extends AbstractPagedByteBufferMemory {
    ...
    PagedUnsafeByteBufferMemory(int pageCntGrow, int pageSizeBits, int initialCapacity) {
    ...
    PagedUnsafeByteBufferMemory() {
        super();
        pageIndexMask = ~ ((long) pageAddrMask);
        pageIndexScaleBits = pageSizeBits - ARRAY_OBJECT_INDEX_SCALE_BITS;
    }

    PagedUnsafeByteBufferMemory(int size) {
        super(size);
        pageIndexMask = ~ ((long) pageAddrMask);
        pageIndexScaleBits = pageSizeBits - ARRAY_OBJECT_INDEX_SCALE_BITS;
    }
